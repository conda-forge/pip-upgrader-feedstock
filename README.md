About pip-upgrader-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pip-upgrader-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/simion/pip-upgrader

Documentation: https://github.com/simion/pip-upgrader
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4078&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pip-upgrader-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pip-upgrader` can be installed with `conda`:
...
```
mamba install pip-upgrader
```

It is possible to list all of the versions of `pip-upgrader` available on your platform with `conda`:
...
```
mamba search pip-upgrader --channel conda-forge
```
...
mamba repoquery search pip-upgrader --channel conda-forge

# List packages depending on `pip-upgrader`:
mamba repoquery whoneeds pip-upgrader --channel conda-forge

# List dependencies of `pip-upgrader`:
mamba repoquery depends pip-upgrader --channel conda-forge
```
